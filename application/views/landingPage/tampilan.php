      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(<?= base_url('assets/img/slide/s1.jpg') ?>)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>TR<i class="fas fa-recycle"></i>SH</span></h2>
        ...
        <div class="carousel-item" style="background-image: url(<?= base_url('assets/img/slide/s2.png') ?>)">
          <div class="carousel-container">
            <div class="container">
              ...
              <p class="animate__animated animate__fadeInUp">Mari kita bergabung dalam perjalanan menuju lingkungan yang lebih bersih dan berkelanjutan! Gunakan web Bank Sampah kami untuk dengan mudah mendaur ulang limbah Anda, peroleh poin, dan terapkan gaya hidup ramah lingkungan</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(<?= base_url('assets/img/slide/s3.jpg') ?>)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown"><span>TR<i class="fas fa-recycle"></i>SH</span></h2>
              <p class="animate__animated animate__fadeInUp">Satu langkah kecil, tapi memiliki dampak besar untuk bumi kita. Ayo, daftarkan diri Anda sekarang dan bersama-sama kita buat dunia ini menjadi tempat yang lebih baik!"</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
